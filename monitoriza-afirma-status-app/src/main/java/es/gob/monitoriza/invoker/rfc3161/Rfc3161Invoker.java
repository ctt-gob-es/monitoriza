...
public class Rfc3161Invoker {
	 ...
	 * @param service DTOService object that contains the service configuration.
	 * @return Long .
	 ...
	 * @param inputParameters Parameter that represents a map with the configuration of the TSA platform. Each key of the map is defined on
	 * {@link ITSAServices}.
