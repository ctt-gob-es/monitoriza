...
public interface ILogRestService {
	...
	/**
	 * Constant attribute that represents the token parameter 'logHost'.
	 */
	String PARAM_LOG_HOST = "logHost";
	
	/**
	 * Constant attribute that represents the token parameter 'logPort'.
	 */
	String PARAM_LOG_PORT = "logPort";
