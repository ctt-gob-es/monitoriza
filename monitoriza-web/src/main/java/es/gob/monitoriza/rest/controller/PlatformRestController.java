...
public class PlatformRestController {
	...
	public DataTablesOutput<PlatformMonitoriza> dtAfirma(@NotEmpty DataTablesInput input) {
	...
	public DataTablesOutput<PlatformMonitoriza> dtTsa(@NotEmpty DataTablesInput input) {
