...
public interface IUserMonitorizaService {
	...
	/**
	 * Method that stores a new user in the persistence.
	 * @param user a {@link UserMonitoriza} with the information of the new user.
	 * @return {@link UserMonitoriza} The new user. 
	 */
	UserMonitoriza addUserMonitoriza(UserMonitoriza user);
	
	/**
	 * Method that modifies a user in the persistence.
	 * @param user a {@link UserMonitoriza} with the information of the user to update.
	 */
	void updateUserMonitoriza(UserMonitoriza user);
	 ...
	 * @return a {@link Iterable<UserMonitorizaPOJO>} with the information of all users.
	 */
	Iterable<UserMonitoriza> getAllUserMonitoriza();
		
	/**
	 * Method that gets all the users from the persistence sorted.
	 * @return a {@link Page<UserMonitorizaPOJO>} with the information of all users sorted.
	 */
	Iterable<UserMonitoriza> getAllSorted(Sort sort);
