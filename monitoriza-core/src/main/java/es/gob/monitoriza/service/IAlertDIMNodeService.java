 ...
 * <b>Project:</b><p>Application for monitoring services of @firma suite systems.</p>
 */
public interface IAlertDIMNodeService {

	/**
	 * Method that gets all the alert audits from the persistence.
	 * @return a {@link Iterable<AlertDIMNode>} with the information of all alert DIM nodes.
	 */
	List<AlertDIMNode> getAllAlertDIMNode();
	 ...
	 * @return The node.
	 */
	AlertDIMNode getAlertDIMNodeById(Long nodeId);
}
