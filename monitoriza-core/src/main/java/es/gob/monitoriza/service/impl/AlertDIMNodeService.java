 ...
 * <b>Project:</b><p>Application for monitoring services of @firma suite systems.</p>
 */
@Service("alertDIMNodeService")
public class AlertDIMNodeService implements IAlertDIMNodeService {

	@Autowired
	private AlertDIMNodeRepository repository;

	@Override
	public List<AlertDIMNode> getAllAlertDIMNode() {
		return this.repository.findAll();
	}

	@Override
	public AlertDIMNode getAlertDIMNodeById(final Long nodeId) {
		return this.repository.findByIdNode(nodeId);
	}
}
