 ...
 * <b>Project:</b><p>Application for monitoring services of @firma suite systems.</p>
 */
public interface ITemplateMonitorizaService {
	 ...
	 */
	TemplateMonitoriza getTemplateMonitorizaById(Long templateId);
	 ...
	 */
	void deleteTemplateMonitoriza(Long templateId);
	 ...
	 */
	Iterable<TemplateMonitoriza> getAllTemplateMonitoriza();
	 ...
	 */
	DataTablesOutput<TemplateMonitoriza> findAll(DataTablesInput input);
