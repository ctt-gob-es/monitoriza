 ...
 * <b>Project:</b><p>Application for monitoring services of @firma suite systems.</p>
 */
@Service("alertDIMTypeService")
public class AlertDIMTypeService implements IAlertDIMTypeService {

	@Autowired
	private AlertDIMTypeRepository repository;

	@Override
	public List<AlertDIMType> getAllAlertDIMType() {
		return this.repository.findAll();
	}

	@Override
	public AlertDIMType getAlertDIMTypeById(final Long typeId) {
		return this.repository.findByIdType(typeId);
	}
}
