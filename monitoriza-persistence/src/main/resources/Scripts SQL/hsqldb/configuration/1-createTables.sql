...
ALTER TABLE "VALID_SERVICE" ADD CONSTRAINT "ID_SYSTEM_CERTIFICATE_FK" FOREIGN KEY ("ID_AUTH_CERTIFICATE") REFERENCES "SYSTEM_CERTIFICATE" ("ID_SYSTEM_CERTIFICATE") ;
...
ALTER TABLE "SERVICE_MONITORIZA" ADD CONSTRAINT "R_REQUEST_FILE" FOREIGN KEY ("ID_REQUEST_FILE") REFERENCES "REQUEST_SERVICE_FILE" ("ID_REQUEST_SERVICE_FILE");
...
COMMENT ON COLUMN "CONF_SERVER_MAIL"."TSL" IS 'TSL del servidor del correo electrónico';
...
COMMENT ON COLUMN "SPIE_SCHEDULED"."ID_TIMER_SCHEDULED" IS 'Identificador de la tabla.';
