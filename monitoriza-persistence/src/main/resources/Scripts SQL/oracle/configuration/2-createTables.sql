...
COMMENT ON COLUMN "VALID_SERVICE"."USERNAME" IS 'Valor que representa el usuario para la conexión con el servicio de validación.';
...
CREATE TABLE "CONF_SPIE" (
	...
	"UPDATE_AFIRMA" CHARACTER(1) DEFAULT 'N',
	"UPDATE_TSA" CHARACTER(1) DEFAULT 'N'
	);
...
COMMENT ON COLUMN "ALERT_APP_TEMPLATES"."DESCRIPTION" IS 'Descripcion asignada a la plantilla.';
...
ALTER TABLE "ALERT_CONFIG" ADD CONSTRAINT "ID_SEVERITY_TYPE_FK" FOREIGN KEY ("ID_SEVERITY_TYPE") REFERENCES "ALERT_SEVERITY" ("ID_SEVERITY_TYPE");
...
COMMENT ON TABLE "ALERT_SYSTEMS_TYPES" IS 'Tabla que recoge los distintos sistemas de notificación.';
COMMENT ON COLUMN "ALERT_SYSTEMS_TYPES"."SYSTEM_TYPE_ID" IS 'Identificador del tipo de sistema de notificación.';
COMMENT ON COLUMN "ALERT_SYSTEMS_TYPES"."NAME" IS 'Nombre asignado al tipo de sistema de notificación.';
COMMENT ON COLUMN "ALERT_SYSTEMS_TYPES"."RESUME_ENABLED" IS 'Valor S/N que indica si el tipo de sistema de notificación permite el envío de resúmenes.';
...
COMMENT ON COLUMN "ALERT_SYSTEMS"."SYSTEM_TYPE_ID" IS 'Cláve foránea hacia la tabla con el tipo de sistema de notificación. ';
...
ALTER TABLE "ALERT_GRAYLOG_SYSTEM_CONFIG" ADD CONSTRAINT "SYSTEM_ID_GRAYLOG_CONS" PRIMARY KEY ("SYSTEM_ID");
...
ALTER TABLE "ALERT_MAIL_RESUME_CONFIG" ADD CONSTRAINT "NOT_SYS_CONFIG_ID_MAIL_CONS" PRIMARY KEY ("RES_SYS_CONFIG_ID" ,"MAIL");
ALTER TABLE "ALERT_MAIL_RESUME_CONFIG" ADD CONSTRAINT "NOT_SYS_CONFIG_ID_FK" FOREIGN KEY ("RES_SYS_CONFIG_ID") REFERENCES "ALERT_RESUME_SYSTEMS" ("RES_SYS_CONFIG_ID");
...
COMMENT ON COLUMN "ALERT_MAIL_RESUME_CONFIG"."MAIL" IS 'Dirección de correo electrónico a la que enviar el resumen.';
...
ALTER TABLE "ALERT_RESUME_LIST" ADD CONSTRAINT "ALERT_RESUME_CONFIG_ID_FK" FOREIGN KEY ("ALERT_CONFIG_ID") REFERENCES "ALERT_CONFIG" ("ALERT_CONFIG_ID");
ALTER TABLE "ALERT_RESUME_LIST" ADD CONSTRAINT "ALERT_RESUME_ID_FK" FOREIGN KEY ("RESUME_ID") REFERENCES "ALERT_RESUMES" ("RESUME_ID");
...
ALTER TABLE "ALERT_RESUME_TYPES" ADD CONSTRAINT "ALERT_RES_TYPES_APP_ID_FK" FOREIGN KEY ("APP_ID") REFERENCES "ALERT_APPLICATIONS" ("APP_ID");
ALTER TABLE "ALERT_RESUME_TYPES" ADD CONSTRAINT "ALERT_RES_TYPES_TYPE_ID_FK" FOREIGN KEY ("TYPE_ID") REFERENCES "ALERT_TYPES" ("TYPE_ID");
ALTER TABLE "ALERT_RESUME_TYPES" ADD CONSTRAINT "ALERT_RES_TYPES_RESUME_ID_FK" FOREIGN KEY ("RESUME_ID") REFERENCES "ALERT_RESUMES" ("RESUME_ID");
...
COMMENT ON TABLE "ALERT_DIM_SEVERITY" IS 'Tabla de dimensión del modelo en estrella orientada a almacenar los nombres de los niveles de criticidad.';
