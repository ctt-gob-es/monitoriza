...
-- TABLA C_NOTIFICATION_ORIGIN    
 ...
 -- TABLA C_NOTIFICATION_PRIORITY  
   ...
   (ID_NOTIFICATION_PRIORITY, TOKEN_NAME, NIVEL)
 Values
...
Insert into ALERT_SYSTEM_TYPE (SYSTEM_TYPE_ID, NAME, RESUME_ENABLED) Values (1, 'EMAIL', 'S');
Insert into ALERT_SYSTEM_TYPE (SYSTEM_TYPE_ID, NAME, RESUME_ENABLED) Values (2, 'GRAYLOG', 'N');
