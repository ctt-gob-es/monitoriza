...
Insert into ALERT_SEVERITY (ID_SEVERITY_TYPE, NAME) Values (3, 'INFO');
 ...
 -- TABLA ALERT_DIM_SEVERITY
 
Insert into ALERT_DIM_SEVERITY
...
Insert into ALERT_AUDIT
  (ALERT_ID, APP_NAME, ALERT_NAME, APP_TEMPLATE_NAME, NODE, SEVERITY, TIMESTAMP, DESCRIPTION) 
Values 
  (1, 'APLICACION 1', 'ALERTA 1', 'PLANTILLA 1', 'NODO.COM', 'INFO', TO_DATE('2021/11/01 21:02:44', 'yyyy/mm/dd hh24:mi:ss'), 'Base de datos actualizada');

Insert into ALERT_AUDIT
  (ALERT_ID, APP_NAME, ALERT_NAME, APP_TEMPLATE_NAME, NODE, SEVERITY, TIMESTAMP, DESCRIPTION) 
Values 
  (2, 'APLICACION 2', 'ALERTA 2', 'PLANTILLA 2', 'HOST.ES', 'WARNING', TO_DATE('2021/09/16 15:21:03', 'yyyy/mm/dd hh24:mi:ss'), 'Error de memoria');
