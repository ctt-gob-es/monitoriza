...
CREATE SEQUENCE SQ_ALERT_APPLICATIONS START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;

-- Secuencia necesaria para la clave de la tabla ALERT_TYPES.
 CREATE SEQUENCE SQ_ALERT_TYPES START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;

-- Secuencia necesaria para la clave de la tabla ALERT_APP_TEMPLATES.
CREATE SEQUENCE SQ_ALERT_APP_TEMPLATES START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;

-- Secuencia necesaria para la clave de la tabla ALERT_CONFIG.
CREATE SEQUENCE SQ_ALERT_CONFIG START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;

-- Secuencia necesaria para la clave de la tabla ALERT_RESUMES.
CREATE SEQUENCE SQ_ALERT_RESUMES START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;

-- Secuencia necesaria para la clave de la tabla ALERT_SYSTEMS.
CREATE SEQUENCE SQ_ALERT_SYSTEMS START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;

-- Secuencia necesaria para la clave de la tabla ALERT_RESUME_SYSTEMS.
CREATE SEQUENCE SQ_ALERT_RESUME_SYSTEMS START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;

-- Secuencia necesaria para la clave de la tabla ALERT_RESUME_LIST.
CREATE SEQUENCE SQ_ALERT_RESUME_LIST START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;

-- Secuencia necesaria para la clave de la tabla ALERT_CONFIG_SYSTEMS.
CREATE SEQUENCE SQ_ALERT_CONFIG_SYSTEMS START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;

-- Secuencia necesaria para la clave de la tabla ALERT_RESUME_TYPES.
CREATE SEQUENCE SQ_ALERT_RESUME_TYPES START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;
  
-- Secuencia necesaria para la clave de la tabla ALERT_AUDIT.
CREATE SEQUENCE SQ_ALERT_AUDIT START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;  

  -- Secuencia necesaria para la clave de la tabla ALERT_AUDIT_CONTROL.
CREATE SEQUENCE SQ_ALERT_AUDIT_CONTROL START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER; 

-- Secuencia necesaria para la clave de la tabla ALERT_STATISTICS.
CREATE SEQUENCE SQ_ALERT_STATISTICS START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;
  
  -- Secuencia necesaria para la clave de la tabla ALERT_DIM_APPS.
CREATE SEQUENCE SQ_ALERT_DIM_APPS START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;
  
    -- Secuencia necesaria para la clave de la tabla ALERT_DIM_NODES.
CREATE SEQUENCE SQ_ALERT_DIM_NODES START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;
  
     -- Secuencia necesaria para la clave de la tabla ALERT_DIM_SEVERITY.
CREATE SEQUENCE SQ_ALERT_DIM_SEVERITY START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;
  
      -- Secuencia necesaria para la clave de la tabla ALERT_DIM_TEMPLATES.
CREATE SEQUENCE SQ_ALERT_DIM_TEMPLATES START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;
  
       -- Secuencia necesaria para la clave de la tabla ALERT_DIM_TYPES.
CREATE SEQUENCE SQ_ALERT_DIM_TYPES START WITH 1 MAXVALUE 999999999999999999999999999 MINVALUE 1 NOCYCLE CACHE 20 ORDER;
