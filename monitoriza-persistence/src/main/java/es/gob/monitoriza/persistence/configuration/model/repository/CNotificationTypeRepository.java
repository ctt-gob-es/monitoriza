...
/** 
 * <p>Interface that provides CRUD functionality for the CNotificationType entity.</p>
 * <b>Project:</b><p>Application for monitoring services of @firma suite systems.</p>
 * @version 1.0, 05/03/2019.
 */
@Repository
public interface CNotificationTypeRepository extends JpaRepository<CNotificationType, Long> {
	
	/**
	  * Method that obtains from the persistence a notification type identified by its primary key. 
	 ...
	 */
	CNotificationType findByIdNotificationType(Long id);
