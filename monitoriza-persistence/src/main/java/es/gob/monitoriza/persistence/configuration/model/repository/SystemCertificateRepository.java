...
public interface SystemCertificateRepository extends JpaRepository<SystemCertificate, Long>, JpaSpecificationExecutor<SystemCertificate> {
	 ...
	 * @return Object that represents a system certificate from the persistence. 
	 */
	SystemCertificate findByKeystoreAndIssuerAndSerialNumber(KeystoreMonitoriza keystore, String issuer, BigInteger serialNumber);
	 ...
	 * @return Object that represents a system certificate from the persistence.
	 */
	SystemCertificate findByKeystoreAndIssuerAndSerialNumberAndUserMonitoriza(KeystoreMonitoriza keystore, String issuer, BigInteger serialNumber, UserMonitoriza userMonitoriza);
