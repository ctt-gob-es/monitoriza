...
/**
 * <p>Interface that provides CRUD functionality for the ResumeMonitoriza entity.</p>
 * <b>Project:</b><p>Application for monitoring services of @firma suite systems.</p>
 */
@Repository
public interface ResumeMonitorizaRepository extends JpaRepository<ResumeMonitoriza, Long> {

	/**
	  * Method that obtains from the persistence a user identified by its primary key.
	 * @param id String that represents the primary key of the resume in the persistence.
	 * @return Object that represents a resume from the persistence.
	 */
	ResumeMonitoriza findByIdResumeMonitoriza(Long id);
