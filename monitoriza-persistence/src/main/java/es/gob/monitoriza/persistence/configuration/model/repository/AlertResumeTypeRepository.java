...
public interface AlertResumeTypeRepository extends JpaRepository<AlertResumeType, Long> {
	 ...
	 * @param id String that represents the primary key of the resume type in the persistence.
	 * @return Object that represents a resume type from the persistence.
	 */
	AlertResumeType findByIdResType(Long id);

	/**
	 * Method that delete all alert resumes of a resume.
