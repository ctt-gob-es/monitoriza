...
public class TimerDTO {
	 ...
	 * @param frequency 
	 */
	public TimerDTO(Long idTimer, String name, Long frequency) {
		super();
	 ...
	 * @param serviceId the value for the attribute {@link #idTimer} to set.
	 */
	 ...
	 * @param serviceId the value for the attribute {@link #name} to set.
	 */
	 ...
	 * @param serviceId the value for the attribute {@link #frequency} to set.
	 */
