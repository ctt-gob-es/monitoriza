...
/** 
 * <b>File:</b><p>es.gob.monitoriza.persistence.configuration.dto.DailyVipDTO.java.</p>
 * <b>Description:</b><p> .</p>
...
public class DailyVipDTO {
	...
	/**
	 * Constructor method for the class DailyVipDTO.java.
	 ...
	 */
	public DailyVipDTO(String statusParam, String systemParam, String serviceParam, LocalDateTime sampligTimeParam) {
		super();
