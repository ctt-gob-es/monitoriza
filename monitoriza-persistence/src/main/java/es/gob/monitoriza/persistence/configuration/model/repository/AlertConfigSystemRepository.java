...
/**
 * <p>Interface that provides CRUD functionality for the AlertConfigSystem entity.</p>
 * <b>Project:</b><p>Application for monitoring services of @firma suite systems.</p>
 */
@Repository
public interface AlertConfigSystemRepository extends JpaRepository<AlertConfigSystem, Long> {
	 ...
	 */
	AlertConfigSystem findByIdNotSysConfig(Long id);

	/**
	 * Method that delete all alert systems of a alert config.
	 * @param alertConfigMonitoriza AlertConfigMonitoriza entity
	 */
