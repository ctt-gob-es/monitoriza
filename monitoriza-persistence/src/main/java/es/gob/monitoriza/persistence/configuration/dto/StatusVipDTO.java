...
public class StatusVipDTO {
	 ...
	 */
	@JsonView(View.class)
	private List<RowStatusVipDTO> data = Collections.emptyList();
	 ...
	 */
	public List<RowStatusVipDTO> getData() {
		return data;
	}
	 ...
	 */
	public void setData(List<RowStatusVipDTO> dataParam) {
		this.data = dataParam;
	}
