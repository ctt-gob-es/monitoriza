 ...
 */
@Repository
public interface CNotificationPriorityRepository extends JpaRepository<CNotificationPriority, Long> {
	
	/**
	  * Method that obtains from the persistence a notification priority identified by its primary key. 
	 ...
	 */
	CNotificationPriority findByIdNotificationPriority(Long id);
