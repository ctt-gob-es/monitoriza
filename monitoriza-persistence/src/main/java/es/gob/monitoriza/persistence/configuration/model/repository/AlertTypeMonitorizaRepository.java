...
public interface AlertTypeMonitorizaRepository extends JpaRepository<AlertTypeMonitoriza, Long> {
	...
	/**
	  * Method that obtains from the persistence a alert type identified by its primary key.
	 * @param id String that represents the primary key of the alert type in the persistence.
	 * @return Object that represents a alert type from the persistence.
	 */
	AlertTypeMonitoriza findByIdTypeMonitoriza(Long id);
