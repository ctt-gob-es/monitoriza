...
set "JAVA_OPTS=%JAVA_OPTS% -Dlog4j.configuration=file:/%CATALINA_HOME%/conf/monitoriza-log4j.xml -Dspring.config.location=%CATALINA_HOME%/conf/application.properties"
