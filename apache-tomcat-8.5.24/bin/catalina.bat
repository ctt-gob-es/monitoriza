...
set "JAVA_OPTS=%JAVA_OPTS% -Dlogging.config=file:/%CATALINA_HOME%/conf/monitoriza-log4j2.xml -Dspring.config.location=%CATALINA_HOME%/conf/application.properties"
