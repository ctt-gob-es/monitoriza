    ...
    private static final class LazyHolder {
        ...
        static {
            ...
            try {
            	...
            	//TODO - Resolver acceso a contexto Spring. Solo para pruebas locales.
            	//ApplicationContext context = new ClassPathXmlApplicationContext("applicationContextTests.xml");

            	//String monitorizaConfigRepository = context.getBean("monitorizaConfigRepository", String.class);
            	String monitorizaConfigRepository = SPUtil.getConfigFilePath();
