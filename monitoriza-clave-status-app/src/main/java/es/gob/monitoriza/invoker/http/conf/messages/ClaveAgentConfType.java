...
/**
 * Define la configuracion para el envio de una peticion SAML sin metadatos, mediante HTTP, al sistema de identificacion Cl@ve (Pasarela o IdP).
 * 
 * <p>Clase Java para ClaveAgentConfType complex type.
 * 
