...
/** 
 * <p>Class that defines the exception object for file not found.</p>
...
public class RequestFileNotFoundException extends Exception {
	 ...
	 */
	private static final long serialVersionUID = -9149917196029537280L;
	 ...
	 * @param cause 
	 */
	public RequestFileNotFoundException(Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public RequestFileNotFoundException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
