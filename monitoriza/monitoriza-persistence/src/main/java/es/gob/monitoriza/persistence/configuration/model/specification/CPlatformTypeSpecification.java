...
public class CPlatformTypeSpecification implements Specification<PlatformMonitoriza>{
	 ...
	 * @param criteria 
	 */
	public CPlatformTypeSpecification(CPlatformType criteria) {
		super();
    ...
    public Predicate toPredicate
      (Root<PlatformMonitoriza> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
        ...
        predicates.add(builder.equal(root.get("platformType").get("idPlatformType"), criteria.getIdPlatformType()));
