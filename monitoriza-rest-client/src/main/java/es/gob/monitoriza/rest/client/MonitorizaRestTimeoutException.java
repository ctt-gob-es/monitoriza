...
/** 
 * <b>File:</b><p>es.gob.monitoriza.rest.client.MonitorizaRestTimeoutException.java.</p>
 * <b>Description:</b><p> Class that manages exceptions produced by network timeout in monitoriz@ rest client.</p>
...
public class MonitorizaRestTimeoutException extends MonitorizaRestException {
	 ...
	 */
	private static final long serialVersionUID = -7788044136940933664L;

	/**
	 * Attribute that represents the object that manages the log of the class.
	 */
	private static final Logger LOGGER = Logger.getLogger(MonitorizaRestTimeoutException.class);
	 ...
	 */
	public MonitorizaRestTimeoutException() {
		super();
	}
	 ...
	 */
	public MonitorizaRestTimeoutException(final String errorCodeParam, final String errorDescParam) {
	 ...
	 */
	public MonitorizaRestTimeoutException(final String errorCodeParam, final String errorDescParam, final Exception exceptionParam) {
		super(errorDescParam);
		errorCode = errorCodeParam;
		errorDesc = errorDescParam;
