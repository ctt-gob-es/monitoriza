...
/** 
 * <b>File:</b><p>es.gob.monitoriza.rest.client.MonitorizaRestHostNotFoundException.java.</p>
 * <b>Description:</b><p> Class that manages exceptions produced by network host not found in monitoriz@ rest client.</p>
...
/** 
 * <p>Class that manages exceptions produced by network host not found in monitoriz@ rest client.</p>
 * <b>Project:</b><p>Application for monitoring services of @firma suite systems.</p>
 * @version 1.0, 13/08/2019.
 */
public class MonitorizaRestHostNotFoundException extends MonitorizaRestException {

	/**
	 * Constant attribute that represents the serial version UID.
	 */
	private static final long serialVersionUID = -4878740377903265347L;

	/**
	 * Attribute that represents the object that manages the log of the class.
	 */
	private static final Logger LOGGER = Logger.getLogger(MonitorizaRestHostNotFoundException.class);
	 ...
	 */
	public MonitorizaRestHostNotFoundException() {
		super();
	}
	 ...
	 */
	public MonitorizaRestHostNotFoundException(final String errorCodeParam, final String errorDescParam) {
	 ...
	 */
	public MonitorizaRestHostNotFoundException(final String errorCodeParam, final String errorDescParam, final Exception exceptionParam) {
		super(errorDescParam);
		errorCode = errorCodeParam;
		errorDesc = errorDescParam;
